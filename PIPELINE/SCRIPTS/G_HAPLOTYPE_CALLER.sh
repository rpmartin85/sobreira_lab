...
-R ${REF_GENOME} --variant ${WD_DIR}/${SM_TAG}_QC_RAW_OnBait.vcf \
--filterExpression 'DP < 8.0' --filterName 'DP' --logging_level ERROR -o ${WD_DIR}/${SM_TAG}_QC_FILTERED_OnBait.vcf
